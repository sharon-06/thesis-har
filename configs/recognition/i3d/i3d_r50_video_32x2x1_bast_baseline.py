...
# dataset settings
ann_type = 'tanz_evaluation' # * _base or _evaluation
...
train_pipeline = [  # list of training pipeline steps
    ...
    dict(
        ...
        frame_interval=2,  # temporal interval of adjacent sampled frames; # frames skipped while sampling
        num_clips=1),
