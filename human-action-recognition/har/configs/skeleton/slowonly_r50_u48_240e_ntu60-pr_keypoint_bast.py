...
ann_file_train = f'data/skeleton/{ann_type}/results/bast_train.pkl'
ann_file_val = f'data/skeleton/{ann_type}/results/bast_val.pkl'
ann_file_test = f'data/skeleton/{ann_type}/results/bast_test.pkl'
...
load_from = ('https://download.openmmlab.com/mmaction/skeleton/posec3d/'
            'slowonly_r50_u48_240e_ntu60_xsub_keypoint/slowonly_r50_u48_240e_ntu60_xsub_keypoint-f3adabf1.pth')
resume_from = None
