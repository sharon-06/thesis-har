...
train_pipeline = [
    ...
    # uniform sampling: separate the clip into 16 sections and sample one frame from each
...
load_from = ('https://download.openmmlab.com/mmaction/recognition/'
            'tsn/tsn_r50_video_1x1x16_100e_diving48_rgb/'
            'tsn_r50_video_1x1x16_100e_diving48_rgb_20210426-63c5f2f7.pth')
resume_from = None
workflow = [('train', 1)]
